...
function makeButton(theItem, myPage, myDoc){
	...
	this.apply = function(myElement, myRuleProcessor){
		...
		myElement.xmlElements.item("artikelInformation").xmlElements.item("iHersteller").texts.everyItem()+"\n"+
		myElement.xmlElements.item("artikelInformation").xmlElements.item("iArtikelBezeichnung").texts.everyItem()+"\n"+
		myElement.xmlElements.item("artikelInformation").xmlElements.item("iArtikelBeschreibung").texts.everyItem()+"\n"+
		myElement.xmlElements.item("artikelInformation").xmlElements.item("iArtikelNr").texts.everyItem()+"\n"+
		...
		myPF01.paragraphs.item(0).appliedParagraphStyle = myDoc.paragraphStyles.item("PREIS");
